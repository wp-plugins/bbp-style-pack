...
function bsp_style_settings_la () {
	...
	<!--Font - Widget title  ------------------------------------------------------------------->
			...
			<td>
			<?php echo '<input id="'.$item1.'" class="large-text" name="'.$item1.'" type="text" value="'.esc_html( $bsp_style_settings_la[$name.$area1] ).'"<br>' ; ?> 
			...
			<td>
			<?php echo '<input id="'.$item2.'" class="large-text" name="'.$item2.'" type="text" value="'.esc_html( $bsp_style_settings_la[$name.$area2] ).'"<br>' ; ?> 
			...
			<td>
			<?php echo '<input id="'.$item3.'" class="large-text" name="'.$item3.'" type="text" value="'.esc_html( $bsp_style_settings_la[$name.$area3] ).'"<br>' ; ?> 
			...
			<?php echo '<option value="'.esc_html( $bsp_style_settings_la[$name.$area4]).'">'.esc_html( $bsp_style_settings_la[$name.$area4] ) ; ?> 
